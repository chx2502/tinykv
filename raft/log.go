...
func (l *RaftLog)sliceIndex(index uint64) int {
	res := int(index - l.FirstIndex)
	if res < 0 {
		panic("sliceIndex: res < 0")
	}
	return res
}

func (l *RaftLog)entryIndex(index int) uint64 {
	return uint64(index) + l.FirstIndex
}
